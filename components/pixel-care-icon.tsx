...
export function PixelCareIcon({ kind, ...props }: SVGProps<SVGSVGElement> & { kind: CareKind | 'heart' }) {
  return (
    <svg viewBox="0 0 16 16" width="32" height="32" fill="none" shapeRendering="crispEdges" aria-hidden="true" {...props}>
      {kind === 'food' ? <>
        ...
        <path d="M2 3h4v1h4V3h4v2h1v5h-2v2h-2v2H9v1H7v-1H5v-2H3v-2H1V5h1Z" fill="currentColor" />
