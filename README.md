...
- Clicking the balance replaces the right-hand shelter with vertical columns for every goods/services category, including zero-spend categories. Switch to **Dogs in your shelter** for exact spending per dog, with real rounded-square portraits and pixel badges. Both views reconcile to Used. Selecting a dog or a transaction returns to the shelter for its replay.
